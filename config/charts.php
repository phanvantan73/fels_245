...
return [
    ...
    */
    ...
    'default' => [
        ...
        'element_label' => 'Total words', // The default chart element label.
        'empty_dataset_label' => 'No Data Set',
        'empty_dataset_value' => 0,
        'title' => 'Chart of words', // Default chart title.
        'height' => 500, // 0 Means it will take 100% of the division height.
        'width' => 1000, // 0 Means it will take 100% of the division width.
        ...
        'template' => 'fusioncharts', // The default chart color template.
