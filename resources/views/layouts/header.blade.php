        ...
        <nav class="main_nav_container">
            <div class="main_nav">
                <ul class="main_nav_list">
                    ...
                    <li class="main_nav_item"><a href="{{ route('processes.index') }}">@lang('message.process')</a></li>
                    <li class="main_nav_item"><a href="{{ route('profile.index') }}">@lang('message.profile')</a></li>
